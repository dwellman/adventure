...
class MansionAdventurePlaybookIntegrationTest {
    ...
    void runsMansionAdventurePlaybook(PlaybookSupport.Playbook playbook) throws Exception {
    ...
    private static Stream<PlaybookSupport.Playbook> playbooks() {
        return Stream.of(
                PlaybookSupport.loadPlaybook("src/test/resources/playbooks/mansion-adventure/playbook.yaml")
        );
    }
}
