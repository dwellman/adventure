...
class IslandAdventurePlaybookIntegrationTest {
    ...
    void runsIslandAdventurePlaybook(PlaybookSupport.Playbook playbook) throws Exception {
    ...
    private static Stream<PlaybookSupport.Playbook> playbooks() {
        return Stream.of(
                PlaybookSupport.loadPlaybook("src/test/resources/playbooks/island-adventure/playbook.yaml"),
                PlaybookSupport.loadPlaybook("src/test/resources/playbooks/island-adventure/playbook-raft.yaml"),
                PlaybookSupport.loadPlaybook("src/test/resources/playbooks/island-adventure/playbook-escape.yaml")
        );
    }
}
