...
class SpyAdventurePlaybookIntegrationTest {
    ...
    void runsSpyAdventurePlaybook(PlaybookSupport.Playbook playbook) throws Exception {
    ...
    private static Stream<PlaybookSupport.Playbook> playbooks() {
        return Stream.of(
                PlaybookSupport.loadPlaybook("src/test/resources/playbooks/spy-adventure/playbook.yaml")
        );
    }
}
