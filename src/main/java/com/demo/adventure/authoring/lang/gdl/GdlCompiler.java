...
public final class GdlCompiler {
    ...
    public GameSave compile(String source) throws GdlCompileException {
        GdlProgram program = new GdlParser(source).parse();
        return compileProgram(program, source == null ? "" : source);
    }

    private GameSave compileProgram(GdlProgram program, String source) throws GdlCompileException {
