...
## Deep Clean Protocol
1. Scope & plan
   - Log the sweep in `docs/housekeeping/cleaning.log` and `docs/bujo/daily/<date>.md`.
   - Record intended tests in `docs/journal.md`.
2. Inventory
...
6. Log & handoff
   - Update `docs/housekeeping/cleaning.log` and `docs/housekeeping/clean-log.md`.
   - Capture risks/follow-ups in BUJO and `docs/journal.md`.
