...
- Moved the top-level `prompts/` markdown files into `src/main/resources/prompts` and updated the gardener expander to load its prompt from classpath resources.
