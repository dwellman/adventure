...
- Added StorybookValidateCli smoke test and documentation under docs/cli.
...
- Ran repo-wide deep clean: added housekeeping docs/logs, updated README/docs for new package layout, cleared stale TODOs, and documented reserved scanner helper.
...
- Added Key Expression syntax doc under docs/design and updated references.
- Moved design docs into docs/design, moved the walkthrough into docs/guides, and kept docs root limited to README/journal.
- Renamed prompt templates in `src/main/resources/prompts/` from .txt to .md and updated gardener expander path.
- Renamed docs/architecture to docs/design, added docs/index.md for the index, and simplified docs/readme.md.
...
- Docs/design rename and docs/index.md may require updating external links that referenced docs/architecture or docs/readme.md.
